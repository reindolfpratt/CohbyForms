...
export const SIGNUP_ENABLED = true; // Enable signup for all environments
...
export const SALESFORCE_CLIENT_ID = env.SALESFORCE_CLIENT_ID;
export const SALESFORCE_CLIENT_SECRET = env.SALESFORCE_CLIENT_SECRET;
...
export const APP_NAME = "CohbyForm";
export const MAIL_FROM = env.MAIL_FROM;
export const MAIL_FROM_NAME = env.MAIL_FROM_NAME || APP_NAME;
